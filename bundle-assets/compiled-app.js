...
// Display order prioritizes complete brand-direction cases, then supporting specialties.
const PROJECT_DISPLAY_ORDER = ["01", "03", "02", "06", "05", "04", "07"];
const PROJECTS_SOURCE = PROJECTS.slice();
PROJECTS.length = 0;
PROJECT_DISPLAY_ORDER.forEach(code => {
  const project = PROJECTS_SOURCE.find(p => p.code === code);
...
function DirectorySection({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    }, /*#__PURE__*/React.createElement("span", null, p.year), /*#__PURE__*/React.createElement("span", null, p.role)), /*#__PURE__*/React.createElement("div", {
...
function AboutSection({
  ...
  return /*#__PURE__*/React.createElement("section", {
    className: "screen sec about-screen",
